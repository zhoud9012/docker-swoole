...
class CommentServer
{
    ...
    public function __construct()
    {
        ...
        $this->_serv->set([
            //'daemonize' => true,
            //'log_file' => '/var/www/html/swoole-log/swoole-9501.log',
            'worker_num' => 1,
        ...
        //监听新端口
        $this->_tcp = $this->_serv->listen('0.0.0.0', 9502, SWOOLE_SOCK_TCP);
        $this->_tcp->set([
                //'daemonize' => true,
                //'log_file' => '/var/www/html/swoole-log/swoole-9502.log',
